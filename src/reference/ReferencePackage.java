...
public interface ReferencePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://atlanmod.neoemf.reference";
	...
	/**
	 * Returns the meta object for the reference '{@link reference.Reference#getEdge <em>Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Edge</em>'.
	 * @see reference.Reference#getEdge()
	 * @see #getReference()
	 * @generated
	 */
	EReference getReference_Edge();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference REFERENCE__EDGE = eINSTANCE.getReference_Edge();
